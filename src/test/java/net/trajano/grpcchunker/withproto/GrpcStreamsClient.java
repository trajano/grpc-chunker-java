...
public class GrpcStreamsClient {
  ...
  public Stream<ResponseSampleEntity> download(SampleEntity request) throws InterruptedException {
    ...
    final var grpcRequest =
        GrpcStreamsOuterClass.MetaAndData.newBuilder()
  ...
  public Stream<ResponseSampleEntity> sendEntities(Stream<SampleEntity> entityStream)
  ...
  public ResponseSampleEntity upload(Stream<SampleEntity> entityStream)
      throws InterruptedException {
  ...
  public Optional<ResponseSampleEntity> upload(Stream<SampleEntity> entityStream, long timeoutInMs)
      throws InterruptedException {
    ...
    if (responseObserver.await(timeoutInMs, TimeUnit.MILLISECONDS)) {
      return responseObserver.getValue().map(ResponseSampleEntity::buildFromMetaAndData);
    } else {
