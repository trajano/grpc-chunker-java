...
class DechunkingStreamObserver<T, R, S> implements StreamObserver<R> {
    ...
    /**
     * This function takes the current entity state and the chunk and returns a copy of the combined result.
     * Note the combiner may modify the existing data, but may cause unexpected behaviour.
     */
    ...
    /**
     * A function that takes in the last assembled object.  This may be null and the object passed into it
     * may also be null.  This is called just before {@link #onCompleted()} is called.
     */
